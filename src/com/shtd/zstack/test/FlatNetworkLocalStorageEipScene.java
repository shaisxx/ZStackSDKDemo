...
public class FlatNetworkLocalStorageEipScene {
	...
	public static void main(String[] args) {
		...
		zBuilder.setHostname("192.168.3.43");
		...
		addKVMHostAction.managementIp = "192.168.3.43";
		...
		addImageStoreBackupStorageAction.hostname = "192.168.3.43";
		...
		networkServices.put(networkServiceProvider.uuid, Arrays.asList("DHCP", "Eip", "Userdata"));
		// 为私有网络添加扁平网络服务
